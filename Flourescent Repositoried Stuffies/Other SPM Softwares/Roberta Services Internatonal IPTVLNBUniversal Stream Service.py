...
# --- FARKLI UYDU VE BÖLGE M3U HAVUZLARI (4444 KANALLARI EKLENDİ) ---
SATELLITE_SOURCES = {
    "4444 Özel Kanal Havuzu": [
        "https://raw.githubusercontent.com/IPTV-Org/iptv/master/index.m3u"  # Buraya dilediğin 4444'lü veya özel M3U linklerini ekleyebilirsin
    ],
        ...
        for source_url in self.selected_urls:
            try:
                ...
                if res.status_code == 200:
                    ...
                    for idx, (name, url, cat) in enumerate(parsed_items[:500]): # Limit artırıldı
...
class SatelliteReceiverHub(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Ro-StreamHub Net | Çoklu Uydu ve Alıcı Sistemi")
        self.setGeometry(30, 30, 1250, 850)
    ...
    def get_stylesheet(self):
        return """
            QMainWindow { background-color: #0b0e14; color: #ffffff; }
